...
# Configure CORS for API routes (allow frontend at localhost:3000, with credentials)
CORS(
    app,
...
# Apply CORS at blueprint-level as well to ensure preflight headers on these routes
CORS(
    api,
    resources={r"/api/*": {"origins": ["http://localhost:3000"]}},
    methods=["GET", "POST", "DELETE", "OPTIONS"],
