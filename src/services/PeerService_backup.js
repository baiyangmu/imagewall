...
async saveDatabaseFile(data) {
  ...
  async saveImageFile(info, data) {
    try {
      ...
      await ImageService.saveImage(blob, info.meta);
      console.log('图片已保存:', info.fileName);
    } catch (error) {
